...
// Calls Claude API — formatting from real filed documents + PLJ Law Site samples
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({ model: 'claude-haiku-4-5-20251001', max_tokens: 4000, system: systemPromptFull, messages: [{ role: 'user', content: userPrompt }] })
    });
